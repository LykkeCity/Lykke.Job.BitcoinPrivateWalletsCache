...
using Lykke.Job.BitcoinPrivateWalletsCache.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.BitcoinPrivateWalletsCache
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "BitcoinPrivateWalletsCache API");
                });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("BitcoinPrivateWalletsCache", ex => new ErrorResponse {ErrorMessage = "Technical problem"});
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.BitcoinPrivateWalletsCacheJob.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "BitcoinPrivateWalletsCacheLog", consoleLogger),
                consoleLogger);
